...
/**
 * gofer theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { goferTheme } from './gofer';
 *   import './gofer.css';
 */
export const goferTheme = {
    name: 'gofer',
    __built: true,
    tokens: {
        ...
        '--font-family-body':
            '"Figtree Variable", Figtree, -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif',
        '--font-family-heading':
            '"Figtree Variable", Figtree, -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif',
        '--font-family-code':
        ...
        '--color-background-surface': 'light-dark(#ebebeb, #262626)',
        '--color-background-body': 'light-dark(#e1e1e1, #1b1b1b)',
        '--color-background-card': 'light-dark(#f5f5f5, #2e2e2e)',
        '--color-background-popover': 'light-dark(#ffffff, #363636)',
        ...
        '--color-text-secondary': 'light-dark(#454545, #c2c2c2)',
        '--color-text-disabled': 'light-dark(#636363, #a1a1a1)',
        ...
        '--color-border': 'light-dark(#868686, #6f6f6f)',
        '--color-border-emphasized': 'light-dark(#767676, #8a8a8a)',
