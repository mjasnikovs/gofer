 ...
 *
 * Some facts a sweep needs are the backend's, not the window's — which directory the running editor
...
/**
 * What the open dialog reads.
 *
 * A dialog is the whole of what it says: the window behind it holds the chat transcript, and a
 * transcript that names the file an approval is about satisfies a search of the window for it
 * whether or not the dialog ever named it.
 */
