...
pub const GODOT_DEBUG_OPERATIONS: &[Operation] = &[
    ...
    op(
        "godot_debug",
        "evaluate",
        "Evaluates an expression in the frame the game is stopped in; a running game is refused as not_stopped, and a paused one as no_frame, because a pause stops it between frames.",
        Answers::Rust,
