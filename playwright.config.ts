...
export default defineConfig({
    ...
    use: {
        ...
        // Reduced motion is a context option rather than a test option, so it is set where
        // Playwright reads it. Spelt as a bare `use` key it was accepted by the config and never
        // reached the browser, which is a screenshot taken mid-animation.
