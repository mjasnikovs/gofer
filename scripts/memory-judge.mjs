...
const JUDGE_SYSTEM_PROMPT =
    ...
    + '\n'
    + 'The memory is one thing an earlier piece of work established and somebody chose to keep: a '
    + 'decision, a preference, a fact about this project, or a known problem. It was written in the '
    + 'past, so it is not wrong merely because it is old: your question is whether what it says '
    + 'about this project is still true of the files as they are NOW.\n'
    + '\n'
    ...
    + 'about how the user wants to work, or about the machine rather than the checkout, makes no '
    + 'claim these files can settle, and is UNCLEAR rather than either of the others.\n'
    + '\n'
    + 'A memory you call broken is DELETED, so say broken only when the files contradict it, never '
    + 'because you could not find what it names.\n'
    + '\n'
